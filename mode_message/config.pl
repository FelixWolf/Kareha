...
#use constant DISPLAY_ID => 'thread board';		# How to display user IDs (0 or '': don't display, any combination of 'day', 'thread', 'board': make IDs change for each day, thread or board, 'static': static IDs)
